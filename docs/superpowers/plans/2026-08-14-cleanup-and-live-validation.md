...
- [ ] **Step 1: 写迁移测试（先红）——test_alembic_migration.py 新增/改写断言**
...
- [ ] **Step 3: models.py 清理（与迁移同提交，保 alembic check 零漂移）**
...
- [ ] **Step 4: services/api_key/service.py save_key 签名更新**
...
- [ ] **Step 4: 测试种子/断言清零（15 处 device_id=None 种子 + 6 文件）**
...
- [ ] **Step 1: 新建 docs/PRD/V2.3/prd_v2_3.md**
...
- [ ] **Step 3: structure-contract.md 同步**

- §9 对照表（资源模型↔表）指向 V2.3；全文 grep 设备残留句清理或标「V2.1 历史」。

- [ ] **Step 4: Progress.md 追加**
...
- [ ] **Step 2: connectedDebugAndroidTest**
