...
本目录是闪卡 App v2.2 的设计契约集合，前后端联调与后端实现的权威依据。需求上游见 [PRD v2.2](../PRD/V2.2/prd_v2_2.md)（继承 v2.1）。
...
1. **需求权威**：`docs/PRD/V2.2/prd_v2_2.md`（继承 v2.1）。契约与 PRD 冲突时，以当前版本 PRD 已确认决策为准，并同步修订另一侧。
...
- 文档与 PRD 版本对齐：v2.2 对应 PRD V2.2（继承 v2.1）。
