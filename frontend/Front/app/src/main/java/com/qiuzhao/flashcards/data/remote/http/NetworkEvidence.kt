...
object ShankaOps {
    ...
    const val ADD_MATERIAL_HTML = "add_project_material_html"
    const val ADD_MATERIAL_MARKDOWN = "add_project_material_markdown"
    const val DELETE_MATERIAL = "delete_project_material"
    const val REPLACE_MATERIAL_PDF = "replace_project_material_pdf"
    const val REPARSE_MATERIAL = "reparse_project_material"
    const val WHOLE_BOOK_FALLBACK = "fallback_whole_book_chapters"
    ...
    const val BEGIN_STUDY_SESSION = "begin_study_session"
    const val REPORT_STUDY_SESSION = "report_study_session"
    const val LIST_STUDY_SESSIONS = "list_study_sessions"
    const val STUDY_SESSION_SUMMARY = "study_session_summary"
